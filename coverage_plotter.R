...
query_repeat <- "~/Analysis/Snake/HT_Workflow/Proto2-Snek/Proto2-Snek.fasta"
...
# plot coverage
ggplot() + geom_segment(data = blastn, aes(x = qstart, xend = qend, y = 100 - pident, yend = 100 - pident), colour = "darkgrey") + # plot all repeats
